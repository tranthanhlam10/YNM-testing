...
https://jira.younetco.com/browse/YNMPECA-9360


2. [TÀI LIỆU DEV / TECHNICAL SPECS]:

/Users/tranthanhlam/YNM-testing/Document/ECI/dev_doc_clickhouse_sync.md
...
file:///Users/tranthanhlam/YNM-testing/Ai_Agents/test_plans/local/eci_weekly_solr_sync/TestPlan_YNMPECA-9360_Weekly_Solr_Sync_Recalculation.md

---
🔻 TEMPLATE TEST CASE & QUY TẮC ĐỊNH DẠNG ĐẦU RA:
Template tham chiếu: https://docs.google.com/spreadsheets/d/13u6hotuwAUSh4ao7FeuwHUUGMzvBrI40REX3iDARrLE/edit?gid=1704880699#gid=1704880699
...
8. PRIORITY: Lấy chữ phần Prefix của test name [Độ ưu tiên]
...
- Những phần module/feature khi tách ra, thì cũng thêm vào phần feature ở tab overview (Nhớ thêm chú giải)
...
- Nếu ở test data có nhiều field, thì viết định dạng 1 object Json
- Nếu ở Expected result có nhiều ý, hãy gạch đầu dòng và xuống dòng từng ý
- Câu chữ tuy vẫn giữ theo chuyên ngành IT, nhưng mà viết như nào có intern/fresher và các stakeholder khác dễ hiểu, và có thể hình dung case phải test và các bước thực hiện



🔻 Output
Sau khi viết xong thì đẩy testcases vào Sheet:
https://docs.google.com/spreadsheets/d/1VqzPpsqxtbB9y2j3r4-NDbpGqtHoT1GKET08Aj7dJf0/edit?gid=1704880699#gid=1704880699
