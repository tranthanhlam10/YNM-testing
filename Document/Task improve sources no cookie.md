...
### Check phần hotfix dành cho source reply
Chạy riêng nhánh fix của Huy trên Staging
threads-ynmpdp-5121-staging-ynm-crawler-empty
kubectl config use-context lamtt-k8s-ovh

kubectl get pods -n crawler-staging | grep threads-ynmpdp-5121-staging-ynm-crawler-empty
kubectl exec -it threads-ynmpdp-5121-staging-ynm-crawler-empty-595dc9668d-q4vqr -n crawler-staging -- sh


// Script chạy luồng source reply
...

{
  ...
  "platform": 10,
  "createdBy": "ThreadsSourceReplyNoCookieCrawlingLoader",
  "link": "threads.com/@dewdrop1909",
  "id_social": "66544713090",
  "username": "dewdrop1909"
}
...

{
  ...
  "last_data_date": "2025-05-01T03:38:57.077Z",
  "from_date": "1733110737",
  "to_date": "1753166632",
  "platform": 10,
  "createdBy": "ThreadsSourceReplyCrawlingLoader",
  "link": "threads.net/@sf._haflywh_",
  "id_social": "66322905550"
}
...

{
  ...
  "platform": 10,
  "createdBy": "ThreadsSourceReplyNoCookieCrawlingLoader",
  "link": "threads.com/@louisy__yyee",
  "id_social": "63432813827",
  "username": "louisy__yyee"
}
louisy__yyee